...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_10__["default"])('.accordion-heading'); // accordion('.accordion-heading', '.accordion-block'); // variant with CSS
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function getPrice(api, optionElem) {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["getResource"])(api).then(function (res) {
  ...
  function createOptions(res, optionElem) {
    res.forEach(function (_ref) {
      var price1 = _ref.price1,
          ...
          price3 = _ref.price3,
          price4 = _ref.price4;
      var priceMass = [price1, price2, price3, price4];
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // проверка для старых браузеров
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    this.remove(); // для this нельзя использовать стрелочную функцию
  });
